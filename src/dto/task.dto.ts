...
// Create Task DTO Validation Schema
...
export const getTasksQuerySchema = Joi.object({
  ...
  sortBy: Joi.string().valid('title', 'due_date', 'status', 'created_at').default('created_at'),
...
export const paginationSchema = Joi.object({
  ...
  sortBy: Joi.string().valid('title', 'due_date', 'status', 'created_at').default('due_date')
    .messages({
      'string.base': 'Sort field must be a string',
      'any.only': 'Sort field must be one of [title, due_date, status, created_at]'
    }),
