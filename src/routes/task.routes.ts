...
import { createTaskSchema, updateTaskSchema, getTasksQuerySchema } from '@/dto/task.dto';
 ...
 * @access  Public
 */
router.get('/', validateRequest(getTasksQuerySchema, 'query'), TaskController.getTasks);
